...
class Order
{
    ...
    {
        $sql = "SELECT o.order_id, o.order_date, o.comment, o.status, o.image_path, c.name as client_name
            FROM orders o
    ...
    public static function create($clientId, $date, $comment, $status, $imagePath)
    {
        DB::connect();
        try {
